...
def index(request,category_slug=None):
    ...
    if category_slug!=None:
        category_page=get_object_or_404(Category,slug=category_slug)   # เป็นการดึงสินค้าและหมวดหมู่มาแสดง
...
def addCart(request,product_id):
    ...
    #สร้างตะกร้าสินค้า
    try:
        cart=Cart.objects.get(cart_id=_cart_id(request))  #เช็คว่าเคยมีตะกร้าสินค้าถูกสร้างขึ้นไหม
